...
This is a parameter change proposal to add a multisig address for [Regen Registry](https://registry.regen.network/), currently managed by members of Regen Network Development (RND), to the list of allowed credit class creators. The RND staff are applying on behalf of the Regen Registry which we envision will become the first community governed registry program, owned and operated by experts committed to ecological regeneration. 

The progressive decentralization of Regen Registry will go hand in hand with the decentralization of this address, which we hope to turn into a groups account which will allow the appropriate stakeholders to become involved in the management and oversight of credit class creation. With this in mind, the RND staff plans to use this address to create credit classes on behalf of Regen Registry, as well as other registry programs, to issue credits on Regen Ledger while we work with the community to progressively decentralize credit class management and governance. In applying on behalf of the Registry, RND is committing to do whatever makes the most sense to bring the Regen Registry, as well as other registry programs, on chain. 
...
- **Carbon*Plus* Agroforestry Credit Class** will facilitate the expansion of agroforestry systems in Brazil and other countries in the pantropic to reverse climate change by supporting the planting of tree species which will provide food and medicine to the community while increasing the amount of carbon stored in plants and the soil.

##  Credit Classes for Credits from Other Registries

In addition to creating credit classes for projects native to the Regen Registry, RND plans to support in the digitization of credits produced by other registries as outlined and allowed by the Registry Program. Regen Ledger is designed to be an open platform which enables transparent monitoring and verification of any and all claims related to ecological state. With this in mind, the RND team hopes to support other registry programs to migrate their credits onto Regen Ledger by creating credit classes which make this possible. We will start by credit classes for the [Verra Verified Carbon Standard (VCS) Program](https://verra.org/project/vcs-program/) and the [City Forestry Credits Tree Preservation Protocols](https://www.cityforestcredits.org/carbon-credits/carbon-protocols/) which have produced credits launching in the Regen marketplace during spring 2022 (see [Kasigau Corridor REDD+ Project](https://registry.regen.network/projects/kasigau) for an example).

##  Plans to Decentralize Regen Registry

At present, Regen Registry is still in the early stages of development. While the RND team are still the primary contributors to the development of the Registry Program, we anticipate Regen Registry being built by a community of experts, including, but not limited to the RND team. With this in mind, our team is working hard to engage our growing network of land stewards, scientists, project, & methodology developers in appreciating the design of the Registry program such that Regen Registry is being built by a diverse set of stakeholders and not by a handful of individuals. 

While we await interfaces to make Regen Ledger more accessible to the broader community, RND plans to use this address take on much of the credit class creation, administration, and issuance. However, in the coming months our we hope to train others to take on these important tasks such that we can shift credit class administration and issuance to our partners and community members. In addition, our team plans to develop user-facing interfaces and other coordination tools like the groups module and multi-signature and "DAO" software which will support decentralized governance of the Registry. 

It is our hope that over the next six months we can successfully decentralize this address to support others ability to create credit classes on Regen Ledger. In doing so, we hope to explore the possibility of transitioning this address into a community-governed meta-registry address which will enable organizations like Verra, Gold Standard, and American Carbon Registry to create credit classes and issue without going through a governance proposal. That being said, the opportunity to apply to become an approved credit class creator is still available to community members, and the community has the right to revoke our ability to create credit classes if we are seen as unsuccessful in our mission to bring the Regen Registry, and other registry programs, on-chain. 

However our mission will not change. At it's core, RND was founded on the idea that collaboration and interdisciplinary knowledge sharing is key to decoding environmental complexity and building tools which best serve regeneration efforts. In submitting this proposal, we hope to continue our mission to bring together academic researchers, land stewards, technologists and climate entrepreneurs to cultivate the broad range of skills, values, and attitudes necessary to built a platform which best serves the needs of our community and our planet. 
